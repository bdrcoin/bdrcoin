...
In order to support loading of multiple wallets in bdrcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bdrcoin.cpp.

Finally, two new headers and source files will have to be added to bdrcoin-qt.pro.
...
Changes to bdrcoin.cpp
----------------------
bdrcoin.cpp is the entry point into bdrcoin-qt, and as such, will require some minor modifications to provide hooks for
