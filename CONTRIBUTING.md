Contributing to BDRcoin Core
============================

The BDRcoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BDRcoin Core project, and is not to be
confused with overall BDRcoin Network Protocol consensus changes.

Whether a pull request is merged into BDRcoin Core rests with the project merge
...
Patches that change BDRcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the BDRcoin consensus, it must have been
...
The project leader is the release manager for each BDRcoin Core release.
