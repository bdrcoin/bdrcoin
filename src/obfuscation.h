...
{
public:
    /// Is the inputs associated with this public key? (and there is 600000 BIDR - checking if valid masternode)
...
public:
    ...
    /// Get the denominations for a specific amount of bdrcoins.
