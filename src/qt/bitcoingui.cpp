                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BDRcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a bdrcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bdrcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BDRcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about BDRcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for bdrcoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your bdrcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified bdrcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a bdrcoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BDRcoin Core help message to get a list with possible BDRcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BDRcoin Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("BDRcoin Core"); // default title
