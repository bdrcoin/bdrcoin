...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BDRcoin features */
        {"bdrcoin", "masternode", &masternode, true, true, false},
        {"bdrcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"bdrcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bdrcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bdrcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bdrcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"bdrcoin", "startmasternode", &startmasternode, true, true, false},
        {"bdrcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bdrcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bdrcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bdrcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bdrcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bdrcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bdrcoin", "mnsync", &mnsync, true, true, false},
        {"bdrcoin", "spork", &spork, true, true, false},
        {"bdrcoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"bdrcoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use bdrcoind, or the -server option to bdrcoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> bdrcoin-cli " + methodname + " " + args + "\n";
}
