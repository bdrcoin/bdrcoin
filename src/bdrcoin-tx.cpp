...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BDRcoin Core bdrcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bdrcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bdrcoin transaction") + "\n" +
                               "  bdrcoin-tx [options] -create [commands]   " + _("Create hex-encoded bdrcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bdrcoin transaction
