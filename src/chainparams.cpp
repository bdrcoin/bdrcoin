...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (200, uint256("0000012ef1cdb8c14feea2dc241018fab50c9ded959a40e9434adbe701b2fdb1"))
    (973, uint256("53891d2ac82fdbe8360fe3abf30c97cc51036ca83d4c0601b930c579435e361e"))
    (1963, uint256("087aaef95439604cda7f1cb936cfffbb7625391b645f8a0816e676b36e60491c"))
;

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1555321266 , // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 12020;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // BDRcoin starting difficulty is 1 / 2^12
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("bdrcoin.top", "bidrseeds.bdrcoin.top"));
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // BDRcoin: 1 minute
        nTargetSpacing = 1 * 60;  // BDRcoin: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet bdrcoin addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet bdrcoin script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet bdrcoin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet bdrcoin BIP32 prvkeys start with 'DRKP'
...
public:
    CRegTestParams()
    {
        ...
        nMinerThreads = 1;
        nTargetTimespan = 1 * 60; // bdrcoin: 1 minutes
        nTargetSpacing = 1 * 60;  // bdrcoin: 1 minutes
