...
This means one can have an always-on bdrcoind instance running, and another local bdrcoind/bdrcoin-qt instance which connects to this node and receives blocks from it.
