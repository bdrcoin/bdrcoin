...
RESOURCES += src/qt/bdrcoin.qrc src/qt/bdrcoin_locale.qrc

TRANSLATIONS += src/qt/locale/bdrcoin_bg.ts \
                src/qt/locale/bdrcoin_de.ts \
                src/qt/locale/bdrcoin_en.ts \
                src/qt/locale/bdrcoin_es.ts \
                src/qt/locale/bdrcoin_fi.ts \
                src/qt/locale/bdrcoin_fr.ts \
                src/qt/locale/bdrcoin_it.ts \
                src/qt/locale/bdrcoin_ja.ts \
                src/qt/locale/bdrcoin_pl.ts \
                src/qt/locale/bdrcoin_pt.ts \
                src/qt/locale/bdrcoin_ru.ts \
                src/qt/locale/bdrcoin_sk.ts \
                src/qt/locale/bdrcoin_sv.ts \
                src/qt/locale/bdrcoin_vi.ts \
                src/qt/locale/bdrcoin_zh_CN.ts \
                src/qt/locale/bdrcoin_zh_TW.ts
